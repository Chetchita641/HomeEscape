...
unrealRootPath=/home/cmacholtz/UnrealEngine-release
HomeEscapeRootPath=/home/cmacholtz/projects/Unreal/HomeEscape/HomeEscape

gameProjectFile=/home/cmacholtz/projects/Unreal/HomeEscape/HomeEscape/HomeEscape.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(HomeEscapeSource.pri)
include(HomeEscapeHeader.pri)
include(HomeEscapeConfig.pri)
include(HomeEscapeIncludes.pri)
include(HomeEscapeDefines.pri)
...
HomeEscape-Linux-Debug.commands = $$build HomeEscape Linux Debug  -project="\"$$gameProjectFile\"" $$args
HomeEscape-Linux-DebugGame.commands = $$build HomeEscape Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
HomeEscape-Linux-Shipping.commands = $$build HomeEscape Linux Shipping  -project="\"$$gameProjectFile\"" $$args
HomeEscape-Linux-Test.commands = $$build HomeEscape Linux Test  -project="\"$$gameProjectFile\"" $$args
HomeEscape.commands = $$build HomeEscape Linux Development  -project="\"$$gameProjectFile\"" $$args

HomeEscapeEditor-Linux-Debug.commands = $$build HomeEscapeEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
HomeEscapeEditor-Linux-DebugGame.commands = $$build HomeEscapeEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
HomeEscapeEditor-Linux-Shipping.commands = $$build HomeEscapeEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
HomeEscapeEditor-Linux-Test.commands = $$build HomeEscapeEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
HomeEscapeEditor.commands = $$build HomeEscapeEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	HomeEscape-Linux-Debug \
	HomeEscape-Linux-DebugGame \
	HomeEscape-Linux-Shipping \
	HomeEscape-Linux-Test \
	HomeEscape \
	HomeEscapeEditor-Linux-Debug \
	HomeEscapeEditor-Linux-DebugGame \
	HomeEscapeEditor-Linux-Shipping \
	HomeEscapeEditor-Linux-Test \
	HomeEscapeEditor \
