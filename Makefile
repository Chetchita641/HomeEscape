...
HomeEscape-Linux-Debug:
	 $(PROJECTBUILD) HomeEscape Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

HomeEscape-Linux-DebugGame:
	 $(PROJECTBUILD) HomeEscape Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

HomeEscape-Linux-Shipping:
	 $(PROJECTBUILD) HomeEscape Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

HomeEscape-Linux-Test:
	 $(PROJECTBUILD) HomeEscape Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

HomeEscape:
	 $(PROJECTBUILD) HomeEscape Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

HomeEscapeEditor-Linux-Debug:
	 $(PROJECTBUILD) HomeEscapeEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

HomeEscapeEditor-Linux-DebugGame:
	 $(PROJECTBUILD) HomeEscapeEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

HomeEscapeEditor-Linux-Shipping:
	 $(PROJECTBUILD) HomeEscapeEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

HomeEscapeEditor-Linux-Test:
	 $(PROJECTBUILD) HomeEscapeEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

HomeEscapeEditor:
	 $(PROJECTBUILD) HomeEscapeEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
